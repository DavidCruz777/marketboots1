...
<head>
  ...
  <script src="//cdn.datatables.net/buttons/2.4.2/js/buttons.print.min.js" type="text/javascript"></script> <!-- DataTables Buttons Print -->
   ...
   <div class="container">
    <main class="mt-3">
        <a href="{{ route('recursos.create') }}" class="btn btn-primary mb-3">Crear Recurso</a>
        <table id="mitabla" class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $recurso['TIP_RECURSO'] }}</td>
                    <td>{{ $recurso['DESC_RECURSO'] }}</td>
                    <td>
                        <a href="{{ route('recursos.edit', $recurso['COD_RECURSO']) }}"
                            class="btn btn-info btn-sm">Editar</a>
                        <form action="{{ route('recursos.destroy', $recurso['COD_RECURSO']) }}" method="POST"
